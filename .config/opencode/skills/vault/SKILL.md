...
1. Read `~/.local/share/vault/.github/copilot-instructions.md` for vault conventions, note format, cross-linking rules, tags, and the full category map. This file is the source of truth.
...
- Use Glob to find notes: `~/.local/share/vault/**/*.md`
- Use Grep to search content across the vault
...
1. **Read the conventions first** — always read `.github/copilot-instructions.md` before writing
